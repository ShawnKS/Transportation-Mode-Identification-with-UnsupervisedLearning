...
X = kfold_dataset[0][0]
Y = kfold_dataset[0][1]
random_sample = np.random.choice(len(X), size=int(0.25*len(X)), replace=True, p=None)
X_train = X[random_sample]
Y_train = Y[random_sample]
X_train.resize(len(X_train),992)
# print(X.shape)
# # print(T_X.shape)
X_test = kfold_dataset[0][2]
Y_test = kfold_dataset[0][4]
X_test.resize(len(X_test),992)
# Decision Tree part
# print(X.shape)
